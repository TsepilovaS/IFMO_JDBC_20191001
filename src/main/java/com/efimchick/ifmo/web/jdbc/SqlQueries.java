...
public class SqlQueries {
    ...
    //language=HSQLDB
    String select05 = "SELECT * FROM EMPLOYEE emp INNER JOIN DEPARTMENT D on emp.DEPARTMENT = D.ID";
    ...
    //language=HSQLDB
    String select10 = "SELECT EMP.LASTNAME AS employee, MANAGER.LASTNAME AS manager "+
